...
Table 1 lists the annual salaries, as of `r paste0("20",oes.src.version)`, by job title (median, and the 25% and 75% percentile), for all occupations identified as having similar names as the normative description. Blank salaries ("NA") indicate that no occupation code could be found on O&ast;Net based on the normative description. 
